            ...
            function cargarDatos() {
                                    ...
                                    if (result.rows.length) {
                                        ...
                                        for (var i = 0; i < result.rows.length; i++) {
                                            ...
                                            $("#listaProductos").append('<tr id="fila' + id + '" class="Reg_A' + id + '"><td><span class="mid">A' +
                                                id + '</span></td><td><span>' + item + '</span></td><td><span>' + precio + '</span></td><td><button>Editar</button></td><td><button>Eliminar</button></td></tr>');
                ...
                $("#insertar").click(function () {
                    ...
                    db.transaction(function (transaction) {
                        ...
                        transaction.executeSql(sql, [item, precio], function () {}, function (transaction, err) {
                            alert(err.message);
                        })
